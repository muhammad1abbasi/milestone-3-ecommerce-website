...
const Hero = () => {
  return (
    <div className='container mx-auto mt-5'>
        <div className='flex flex-col md:flex-row justify-evenly items-center space-y-5 md:space-y-0 md:space-x-44'>
            ...
            <button className='rounded-lg border bg-red-600 py-6 px-12 text-white font-bold '>
                Get Ready For Shop 
            </button>
            </div>
            </div>
